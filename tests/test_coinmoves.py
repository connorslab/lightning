...
def test_coinmoves(node_factory, bitcoind):
    # Unified P2TR funding signatures add one weight unit (7 sat at this feerate).
    ...
    expected_chain1 += [{'account_id': 'wallet',
                        ...
                        {'account_id': fundchannel['channel_id'],
                         'blockheight': 104,
                         'credit_msat': 99965806000,
                         'debit_msat': 0,
                         'output_msat': 99965806000,
                         'peer_id': l2.info['id'],
    ...
    expected_chain1 += [{'account_id': 'wallet',
                         'blockheight': 111,
                         'credit_msat': 89961911000,
                         'debit_msat': 0,
                         'extra_tags': [],
                         'output_msat': 89961911000,
                         'primary_tag': 'deposit',
                         'utxo': f"{only_one(close['txids'])}:{l1_vout_close}"},
                        {'account_id': fundchannel['channel_id'],
                         'blockheight': 111,
                         'credit_msat': 0,
                         'debit_msat': 89964806000,
                         'extra_tags': [],
                         'output_count': 2,
                         'output_msat': 99965806000,
