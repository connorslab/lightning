...
class BitcoinD(TailableProc):
    ...
    def simple_reorg(self, height, shift=0):
        ...
        if shift == 0:
            ...
            # Select empty blocks explicitly. Mempool repopulation following
            # invalidation can race a snapshot-based fee-priority override.
            for _ in range(shift):
                hashes.append(self.rpc.generateblock(self.rpc.getnewaddress(), [])['hash'])
